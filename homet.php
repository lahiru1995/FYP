...
<div class="container">
      ...
      <div class="col text-center">
        <div class="col-lg-12">
          <p>
            <a href="classt.php?q=1" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-info">
                <i class="fa fa-user fa-5x"></i><br/>
               -  G  R  A  D  E  - <br> 0 1
            </a>
            <a href="classt.php?q=2" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-info">
                <i class="fa fa-user fa-5x"></i><br/>
                -  G  R  A  D  E  - <br> 0 2
            </a>
            <a href="classt.php?q=3" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-info">
                <i class="fa fa-user fa-5x"></i><br/>
                -  G  R  A  D  E  - <br> 0 3
            </a>
            <a href="classt.php?q=4" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-info">
                <i class="fa fa-user fa-5x"></i><br/>
                -  G  R  A  D  E  - <br> 0 4
            </a>
            <a href="classt.php?q=5" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-info">
                <i class="fa fa-user fa-5x"></i><br/>
                -  G  R  A  D  E  - <br> 0 5
            </a>
          </p>
    ...
    <div class="col text-center">
        <div class="col-lg-12">
          <p>
            <a href="classt.php?q=6" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-primary">
                <i class="fa fa-user fa-5x"></i><br/>
                -  G  R  A  D  E  - <br> 0 6
            </a>
            <a href="classt.php?q=7" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-primary">
                <i class="fa fa-user fa-5x"></i><br/>
                -  G  R  A  D  E  - <br> 0 7
            </a>
            <a href="classt.php?q=8" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-primary">
              <i class="fa fa-user fa-5x"></i><br/>
              -  G  R  A  D  E  - <br> 0 8
            </a>
            <a href="classt.php?q=9" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-primary">
              <i class="fa fa-user fa-5x"></i><br/>
              -  G  R  A  D  E  - <br> 0 9
            </a>
            <a href="classt.php?q=10" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-primary">
              <i class="fa fa-user fa-5x"></i><br/>
              -  G  R  A  D  E  - <br> 1 0
            </a>
            <a href="classt.php?q=11" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-primary">
              <i class="fa fa-user fa-5x"></i><br/>
              -  G  R  A  D  E  - <br> 1 1
            </a>
          </p>
    ...
    <div class="col text-center">
        <div class="col-lg-12">
          <p>
          <a href="home_alt.php" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-success">
              <i class="fa fa-user fa-5x"></i><br/>
              -  G  R  A  D  E  - <br> 1 2
            </a>
            <a href="home_al1t.php" style="margin:0px 5px 0px 5px" class="btn btn-sq-lg btn-success">
              <i class="fa fa-user fa-5x"></i><br/>
              -  G  R  A  D  E  - <br> 1 3
            </a>
