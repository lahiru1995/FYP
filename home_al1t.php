...
<div class="container">
      ...
      <div class="col text-center">
        <div class="col-lg-12">
          <p>
            <a style="width: 200px" href="classt.php?q=113" class="btn btn-sq-lg btn-info">
                <i class="fa fa-book fa-5x"></i><br/>
               -  Physical Science Subjects - <br> 
            </a>
            <a style="width: 200px" href="classt.php?q=213" class="btn btn-sq-lg btn-info">
                <i class="fa fa-book fa-5x"></i><br/>
                -  Biological Science Subjects - <br>
            </a>
            <a style="width: 200px" href="classt.php?q=313" class="btn btn-sq-lg btn-info">
                <i class="fa fa-book fa-5x"></i><br/>
                -  Commerce Subjects - <br> 
            </a>
            <a style="width: 200px" href="classt.php?q=413" class="btn btn-sq-lg btn-info">
                <i class="fa fa-book fa-5x"></i><br/>
                -  Arts Subjects - <br> 
            </a>
            <a style="width: 200px" href="classt.php?q=513" class="btn btn-sq-lg btn-info">
                <i class="fa fa-book fa-5x"></i><br/>
